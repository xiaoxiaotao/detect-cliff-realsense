...
void CliffDetector::findCliffInDepthImage(const sensor_msgs::ImageConstPtr &depth_msg)
{
  ...
  for(it = stairs_points.begin(); it != stairs_points.end(); ++it)
  {
    ...
    // std::cout<<(*it)[Col]<<" "<<camera_model_.cx()<<" "<<camera_model_.fx()<<std::endl;
    // std::cout<<Col<<" "<<Row<<" "<<Depth<< std::endl;//1 0 2
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    std::cout<<"Stairs points: " << stairs_points_msg_.size<<std::endl;
    std::cout<<angle_max<<" " << angle_min<<std::endl;

    std::map<float,float> data_xz;
